...
var ErrVersion = errors.New("TTC version error")
 ...
 */
func TTCEncode(data []byte, prefix byte) string {
 ...
 */
func TTCDecode(input string) (result []byte, version byte, err error) {
...
// func CheckTTCVersion(input byte) bool {
// 	return input == versionTTC
// }
